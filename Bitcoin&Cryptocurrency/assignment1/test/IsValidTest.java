 ...
 * <p>
 * Test Strategy: Test 1: test isValidTx() with valid transactions Test 2: test
 * isValidTx() with transactions containing signatures of incorrect data Test 3:
 * test isValidTx() with transactions containing signatures using incorrect
 * private keys Test 4: test isValidTx() with transactions whose total output
 * value exceeds total input value Test 5: test isValidTx() with transactions
 * that claim outputs not in the current utxoPool Test 6: test isValidTx() with
 * transactions that claim the same UTXO multiple times Test 7: test isValidTx()
 * with transactions that contain a negative output value
 * 
 * @author ealbertos
 *
 */
...
public class IsValidTest {
	...
	public void testIsValidWithInvalidSignatures()
		...
		final UtxoTestSet utxoTestSet = UtxoTestSet.builder().setPeopleSize(10).setUtxoTxNumber(10)
				.setMaxUtxoTxOutput(10).setMaxValue(200).setTxPerTest(10).setMaxInput(10).setMaxOutput(10)
				.setForceCorruptedSignature(true).setCorruptedPercentage(.20) // probability
																				// of
																				// 20%
																				// of
																				// invalid
	...
	public void testIsValidSignaturesWithInvalidPrivateKeys()
		...
		final UtxoTestSet utxoTestSet = UtxoTestSet.builder().setPeopleSize(10).setUtxoTxNumber(10)
				.setMaxUtxoTxOutput(10).setMaxValue(200).setTxPerTest(10).setMaxInput(10).setMaxOutput(10)
				.setInvalidPrivateKeys(true) // corrupt the private key that
												// signs
				.setCorruptedPercentage(.20) // probability of 20% of invalid
												// transactions
				.build();
	...
	public void testIsValidTotalOutputExceedsTotalInput()
		...
		final UtxoTestSet utxoTestSet = UtxoTestSet.builder().setPeopleSize(10).setUtxoTxNumber(10)
				.setMaxUtxoTxOutput(10).setMaxValue(200).setTxPerTest(10).setMaxInput(10).setMaxOutput(10)
				.setInvalidTotals(true) // create transactions with invalid
										// total value
				.setCorruptedPercentage(.20) // probability of 20% of invalid
												// transactions
				.build();
	...
	public void testIsValidTransactionsClamingOuputsNotInThePool()
		...
		final UtxoTestSet utxoTestSet = UtxoTestSet.builder().setPeopleSize(10).setUtxoTxNumber(10)
				.setMaxUtxoTxOutput(10).setMaxValue(200).setTxPerTest(10).setMaxInput(10).setMaxOutput(10)
				.setClaimingOutputsNotInPool(true) // create transactions
													// claiming outputs not in
													// the pool
				.setCorruptedPercentage(.20) // probability of 20% of invalid
												// transactions
				.build();
	...
	public void testIsValidTransactionsClaimingTheSameUTXOSeveralTimes()
		...
		final UtxoTestSet utxoTestSet = UtxoTestSet.builder().setPeopleSize(10).setUtxoTxNumber(10)
				.setMaxUtxoTxOutput(10).setMaxValue(200).setTxPerTest(10).setMaxInput(10).setMaxOutput(10)
				.setClaimingUtxoSeveralTimes(true) // create transactions
													// claiming the same output
													// several times
				.setCorruptedPercentage(.20) // probability of 20% of invalid
												// transactions
				.build();
	...
	public void testIsValidTransactionsWithNegativeOutput()
		...
		final UtxoTestSet utxoTestSet = UtxoTestSet.builder().setPeopleSize(10).setUtxoTxNumber(10)
				.setMaxUtxoTxOutput(10).setMaxValue(200).setTxPerTest(10).setMaxInput(10).setMaxOutput(10)
				.setNegativeOutputs(true) // create transactions with negative
											// values
				.setCorruptedPercentage(.20) // probability of 20% of invalid
												// transactions
				.build();
