...
public class Main {
	...
	public static void main(String[] args)
		...
		// and it contains the coin from Scrooge, therefore I have to sign with
		// the private key from Scrooge
		...
		/*
		 * Create alternative block, block2 from scrooge with tx scrooge ->
		 * scrooge
		 */
	...
	public static class Tx extends Transaction {
		public void signTx(PrivateKey sk, int input) throws SignatureException {
			...
			// Note that this method is incorrectly named, and should not in
			// fact override the Java
